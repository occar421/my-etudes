...
#[async_trait]
pub trait RelationshipTuplesApi: Send + Sync {
    async fn read<'store_id, 'body>(&self, store_id: &'store_id str, body: models::ReadRequest) -> Result<models::ReadResponse, Error<ReadError>>;
    async fn read_changes<'store_id, 'r_type, 'page_size, 'continuation_token, 'start_time>(&self, store_id: &'store_id str, r#type: Option<&'r_type str>, page_size: Option<i32>, continuation_token: Option<&'continuation_token str>, start_time: Option<String>) -> Result<models::ReadChangesResponse, Error<ReadChangesError>>;
    async fn write<'store_id, 'body>(&self, store_id: &'store_id str, body: models::WriteRequest) -> Result<serde_json::Value, Error<WriteError>>;
}

pub struct RelationshipTuplesApiClient {
    configuration: Arc<configuration::Configuration>
}

impl RelationshipTuplesApiClient {
...
#[async_trait]
impl RelationshipTuplesApi for RelationshipTuplesApiClient {
